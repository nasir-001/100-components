...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/layout26',
      name: 'twentysix',
      component: () => import('./views/Layout26.vue')
    },
    {
      path: '/layout27',
      name: 'twentyseven',
      component: () => import('./views/Layout27.vue')
    },
    {
      path: '/layout28',
      name: 'twentyeight',
      component: () => import('./views/Layout28.vue')
    },
    {
      path: '/layout29',
      name: 'twentynine',
      component: () => import('./views/Layout29.vue')
    },
    {
      path: '/layout30',
      name: 'thirty',
      component: () => import('./views/Layout30.vue')
    }
  ],
});
